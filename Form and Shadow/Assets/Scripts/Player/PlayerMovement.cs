...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        transform.position = playerShadow.transform.position + -LightSourceControl.lightSourceDirection * camControl.distanceToPlayer2D;
    }
	...
	public void ShiftingOutControl()
	{
		...
		{
			StartCoroutine(CameraPanInMultiExit(transitionFollow.transform.position, playerShadow.transform.position, -LightSourceControl.lightSourceDirection * camControl.distanceToPlayer2D));
